...
var errorCatalog = map[string]*AppError{
	...
	"conversation group name already exists":                                           NewAppError(http.StatusConflict, 2002385, "Conversation group name already exists"),
	"conversation group not found":                                                     NewAppError(http.StatusNotFound, 2002386, "Conversation group not found"),
	"conversation is locked by organizer":                                              NewAppError(http.StatusConflict, 2002387, "Conversation is being organized"),
	"conversation membership changed":                                                  NewAppError(http.StatusConflict, 2002388, "Conversation membership changed"),
	"conversation organizer run cannot be canceled":                                    NewAppError(http.StatusConflict, 2002389, "Conversation organizer run cannot be canceled"),
	"conversation organizer run cannot be retried":                                     NewAppError(http.StatusConflict, 2002396, "Conversation organizer run cannot be retried"),
	"conversation organizer run cannot be undone":                                      NewAppError(http.StatusConflict, 2002397, "Conversation organizer run cannot be undone"),
	"no free conversations to organize":                                                NewAppError(http.StatusConflict, 2002390, "No free conversations to organize"),
	"conversation group name must contain 1 to 24 characters":                          NewAppError(http.StatusBadRequest, 2002391, "Conversation group name must contain 1 to 24 characters"),
	"conversation group scope must not exceed 500 characters":                          NewAppError(http.StatusBadRequest, 2002392, "Conversation group scope must not exceed 500 characters"),
	"group_id is only valid when creating a conversation":                              NewAppError(http.StatusConflict, 2002393, "group_id is only valid when creating a conversation"),
	"child conversation cannot be grouped independently":                               NewAppError(http.StatusConflict, 2002394, "Child conversation cannot be grouped independently"),
	"conversation organizer run not found":                                             NewAppError(http.StatusNotFound, 2002395, "Conversation organizer run not found"),
	"conversation or conversation group not found":                                     NewAppError(http.StatusNotFound, 2002398, "Conversation or conversation group not found"),
	"conversation organizer lease lost":                                                NewAppError(http.StatusConflict, 2002399, "Conversation organizer lease lost"),
	"invalid organizer payload":                                                        NewAppError(http.StatusBadRequest, 2002400, "Invalid organizer payload"),
	"algorithm organizer failed":                                                       NewAppError(http.StatusBadGateway, 2002401, "Algorithm organizer failed"),
	"algorithm returned empty checkpoint":                                              NewAppError(http.StatusBadGateway, 2002402, "Algorithm returned an empty checkpoint"),
	"algorithm returned done without proposal":                                         NewAppError(http.StatusBadGateway, 2002403, "Algorithm returned done without a proposal"),
	"conversation organizer exceeded step limit":                                       NewAppError(http.StatusInternalServerError, 2002404, "Conversation organizer exceeded its step limit"),
	"proposal contains unknown conversation":                                           NewAppError(http.StatusBadGateway, 2002405, "Organizer proposal contains an unknown conversation"),
	"proposal contains duplicate conversation":                                         NewAppError(http.StatusBadGateway, 2002406, "Organizer proposal contains a duplicate conversation"),
	"proposal contains invalid candidate id":                                           NewAppError(http.StatusBadGateway, 2002407, "Organizer proposal contains an invalid candidate"),
	"proposal references stale conversation group":                                     NewAppError(http.StatusConflict, 2002408, "Organizer proposal references a changed conversation group"),
	"proposal repeats conversation group":                                              NewAppError(http.StatusBadGateway, 2002409, "Organizer proposal repeats a conversation group"),
	"proposal does not partition the snapshot":                                         NewAppError(http.StatusBadGateway, 2002410, "Organizer proposal does not cover the snapshot exactly once"),
	"automatic conversation group scope required":                                      NewAppError(http.StatusBadGateway, 2002411, "Automatic conversation group scope is required"),
	"conversation organizer model config changed":                                      NewAppError(http.StatusConflict, 2002412, "Conversation organizer model configuration changed"),
	"load organizer model config failed":                                               NewAppError(http.StatusInternalServerError, 2002413, "Failed to load organizer model configuration"),
	"conversation organizer result cannot be confirmed":                                NewAppError(http.StatusConflict, 2002414, "Conversation organizer result cannot be confirmed"),
	"conversation organizer run cannot be retried before reviewing the current result": NewAppError(http.StatusConflict, 2002415, "Review the current organizer result before retrying"),
	"proposal contains invalid unassigned reason":                                      NewAppError(http.StatusBadGateway, 2002416, "Organizer proposal contains an invalid unassigned reason"),
	"opening preparer is not registered":                                               NewAppError(http.StatusInternalServerError, 2002417, "Conversation opening preparer is not registered"),
	"unsupported organizer preparation version":                                        NewAppError(http.StatusInternalServerError, 2002418, "Unsupported organizer preparation version"),
	"previous organizer execution has not confirmed termination":                       NewAppError(http.StatusConflict, 2002419, "Previous organizer execution has not confirmed termination"),
}
