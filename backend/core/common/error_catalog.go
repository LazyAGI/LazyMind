...
var errorCatalog = map[string]*AppError{
	...
	"algorithm leap service is not started in this runtime": NewAppError(http.StatusServiceUnavailable, 2001227, "algorithm leap service is not started in this runtime"),
