...
func init() {
	...
	registerAdditionalErrorAlias("-version vN is required for the structured migration layout", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
	registerAdditionalErrorPattern("invalid version %q; expected vN", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
	...
	registerAdditionalErrorPattern("version migration IDs must increase with release versions; %s maps to %d after %d", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
	...
	registerAdditionalErrorPattern("parse %s", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
	registerAdditionalErrorPattern("%s contains trailing JSON data", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
	...
	registerAdditionalErrorPattern("invalid release version %q; expected vN", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
	...
	registerAdditionalErrorPattern("applied migration version %d has no migration file or version mapping; refusing to execute SQL", "Database migration configuration is invalid", http.StatusBadRequest, 2001991)
