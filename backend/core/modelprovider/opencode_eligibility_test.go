...
func TestResolveOpenCodeModel(t *testing.T) {
	tests := []struct {
		...
		{"qwen llm", "Qwen", "qwen-plus", "https://dashscope.aliyuncs.com/", "llm", true, true, "alibaba-cn/qwen-plus", "https://dashscope.aliyuncs.com/compatible-mode/v1"},
		{"openai vlm", "OpenAI", "gpt-4o-mini", "https://api.openai.com/v1/", "vlm", true, true, "openai/gpt-4o-mini", "https://api.openai.com/v1"},
		{"pr14 openai addition", "OpenAI", "gpt-5.5", "https://api.openai.com/v1/", "vlm", true, true, "openai/gpt-5.5", "https://api.openai.com/v1"},
		...
		{"empty endpoint rejected", "OpenAI", "gpt-4o-mini", "", "vlm", false, false, "", ""},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, ok := ResolveOpenCodeModel(tt.provider, tt.model, tt.baseURL, tt.technicalType, tt.isDefault)
