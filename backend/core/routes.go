...
func registerAllRoutes(r *mux.Router) {
	...
	// ----- Agent thread stream -----
	handleAPI(r, "GET", "/agent/threads", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.ListThreads))
	handleAPI(r, "POST", "/agent/threads", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.CreateThread))
	handleAPI(r, "GET", "/agent/threads/{thread_id}:events", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.StreamThreadEvents))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/events/{step_id}", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.StreamThreadStepEvents))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/steps", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.ListThreadSteps))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/steps/{step_id}/records", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.ListThreadStepRecords))
	handleAPI(r, "GET", "/agent/threads/{thread_id}", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThread))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/history", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadHistory))
	handleAPI(r, "DELETE", "/agent/threads/{thread_id}:history", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.DeleteThreadHistory))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/rounds", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.ListThreadRounds))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/records", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.ListThreadRecords))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/datasets", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultDatasets))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/eval-reports", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultEvalReports))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/eval-reports/{report_id}/bad-cases", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadEvalReportBadCases))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/analysis-reports", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultAnalysisReports))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/diffs", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultDiffs))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/abtests", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultAbtests))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/abtests/{abtest_id}/case-details", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadABTestCaseDetails))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/flow-status", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadFlowStatus))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/artifacts/{artifact_id}", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadArtifact))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/traces/{trace_id}", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultTrace))
	handleAPI(r, "GET", "/agent/threads/{thread_id}/results/traces-compare", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetThreadResultTraceCompare))
	handleAPI(r, "POST", "/agent/threads/{thread_id}:messages", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.StreamThreadMessages))
	handleAPI(r, "POST", "/agent/threads/{thread_id}:start", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.StartThread))
	handleAPI(r, "POST", "/agent/threads/{thread_id}:pause", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.PauseThread))
	handleAPI(r, "POST", "/agent/threads/{thread_id}:cancel", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.CancelThread))
	handleAPI(r, "POST", "/agent/threads/{thread_id}:retry", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.RetryThread))
	handleAPI(r, "POST", "/agent/threads/{thread_id}:continue", []string{"qa.write"}, agent.RequireEvoServiceEnabled(agent.ContinueThread))
	handleAPI(r, "GET", "/agent/reports/{report_id}:content", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetReportContent))
	handleAPI(r, "GET", "/agent/diffs/{apply_id}/{filename:.*}", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetDiffContent))
	handleAPI(r, "POST", "/agent/files:content", []string{"qa.read"}, agent.RequireEvoServiceEnabled(agent.GetAgentFileContent))
