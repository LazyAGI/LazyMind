...
func TestApplyLocalFSPathsForChatAddsActiveLocalBindings(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case "/api/scan/sources/source-2":
			...
			_ = json.NewEncoder(w).Encode(map[string]any{
				"bindings": []map[string]any{
					{"binding_id": "bind-2a", "connector_type": "local_fs", "target_type": "local_path", "target_ref": "/Users/me/projects", "status": "ACTIVE", "chat_enabled": true, "include_extensions": []string{"pdf", "md", "txt"}},
	...
	want := []map[string]any{
		{"source_id": "source-2", "paths": []string{"/Users/me/projects", "/Users/me/downloads"}, "file_extensions": []string{"doc", "docx", "md", "pdf", "txt"}},
	}
