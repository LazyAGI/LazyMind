...
CREATE TABLE conversation_group_members (
 ...
 user_id VARCHAR(255) NOT NULL, revision BIGINT NOT NULL DEFAULT 1,
 source VARCHAR(16) NOT NULL DEFAULT 'user', source_run_id VARCHAR(64) NOT NULL DEFAULT '',
...
CREATE TABLE conversation_organizer_runs (
 ...
 model_config_json JSON NOT NULL, checkpoint_json JSON, proposal_json JSON, result_json JSON,
 progress_current BIGINT NOT NULL DEFAULT 0, progress_total BIGINT NOT NULL DEFAULT 0,
 version BIGINT NOT NULL DEFAULT 1, job_id VARCHAR(64) NOT NULL DEFAULT '',
 error_code VARCHAR(64) NOT NULL DEFAULT '', error_message TEXT NOT NULL DEFAULT '',
 created_at TIMESTAMP NOT NULL, updated_at TIMESTAMP NOT NULL, finished_at TIMESTAMP, undone_at TIMESTAMP
);
