...
func conversationGroupSchemas() map[string]any {
	...
	return map[string]any{
		...
		"ConversationOrganizerRun": objReq([]string{"id", "status", "stage", "progress", "organized_count", "free_count", "skipped_count", "can_cancel", "can_retry", "can_undo", "created_at", "updated_at"},
			...
			prop("progress", objReq([]string{"current", "total"}, prop("current", int64Schema()), prop("total", int64Schema()), prop("batch_current", int64Schema()), prop("batch_total", int64Schema()), prop("preparation_current", int64Schema()), prop("preparation_total", int64Schema()))),
			...
			prop("can_cancel", boolSchema()), prop("can_retry", boolSchema()), prop("can_undo", boolSchema()), prop("created_at", dateTimeSchema()), prop("updated_at", dateTimeSchema()), prop("items", array(refSchema("ConversationOrganizerItem")))),
