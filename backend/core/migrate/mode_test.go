...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	if len(v03.Dev) != 57 {
		t.Fatalf("v0_3 dev migration count=%d, want 57", len(v03.Dev))
	}
