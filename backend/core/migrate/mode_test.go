...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	if len(v03.Dev) != 75 {
		t.Fatalf("v0_3 dev migration count=%d, want 75", len(v03.Dev))
	}
