...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	if len(v03.Dev) != 31 {
		t.Fatalf("v0_3 dev migration count=%d, want 31", len(v03.Dev))
	}
	for _, version := range []uint64{20260730100000, 20260803120000, 20260803150000, 20260803160000, 20260803220000, 20260804090000, 20260804100000, 20260805100000, 20260805120000, 20260805121000, 20260805173000, 20260806120000, 20260806173000, 20260807120000, 20260807160000, 20260809203000, 20260810100000, 20260811120000, 20260811153000, 20260811173000, 20260813120000, 20260813140000, 20260813190000, 20260814110000, 20260814120000, 20260814121000, 20260815160000, 20260816120000, 20260817084853, 20260817120000, 20260818064304} {
	...
	for _, token := range []string{"workflow_preparations", "workflow_outbox", "workflow_input_resources", "driver_content", "chat_executor", "external_chat_run_events", "external_chat_hosts", "lease_token", "sub_agent_tasks", "sources", "plugin_step_intents", "run_id", "run_status", "run_terminal"} {
