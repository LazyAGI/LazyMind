...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	for _, version := range []uint64{20260820120000, 20260826062049, 20260906140951, 20260914090000, 20260909073741, 20260909193000, 20260910080000, 20260912063102, 20260912065741, 20260918100000} {
		if !containsMigrationFileVersion(v03.Dev, version) {
			t.Fatalf("v0_3 dev migrations are missing %d", version)
		}
	}
