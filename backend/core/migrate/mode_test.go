...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	if len(v03.Dev) != 18 {
		t.Fatalf("v0_3 dev migration count=%d, want 18", len(v03.Dev))
	}
	for _, version := range []uint64{20260730100000, 20260803120000, 20260803150000, 20260803160000, 20260803220000, 20260804090000, 20260805100000, 20260805120000, 20260805121000, 20260805173000, 20260806173000, 20260807160000, 20260809203000, 20260810100000, 20260811120000, 20260811153000, 20260811173000, 20260814120000} {
	...
	for _, token := range []string{"workflow_preparations", "workflow_outbox", "workflow_input_resources", "driver_content", "sub_agent_tasks", "sources"} {
