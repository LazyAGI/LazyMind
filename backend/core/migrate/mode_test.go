...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	if len(v03.Dev) != 79 {
		t.Fatalf("v0_3 dev migration count=%d, want 79", len(v03.Dev))
	}
