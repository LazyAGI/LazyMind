...
def upgrade() -> None:
    op.add_column('cloud_auth_connections', sa.Column('connection_method', sa.String(length=32), nullable=False, server_default='legacy_byo'))
    op.add_column('cloud_auth_connections', sa.Column('credential_location', sa.String(length=16), nullable=False, server_default='local'))
    op.add_column('cloud_auth_connections', sa.Column('cloud_connection_id', sa.String(length=64), nullable=True))
    op.add_column('cloud_auth_connections', sa.Column('cloud_owner_user_id', sa.String(length=64), nullable=False, server_default=''))
    op.add_column('cloud_auth_connections', sa.Column('provider_workspace_id', sa.String(length=255), nullable=False, server_default=''))
    op.add_column('cloud_auth_connections', sa.Column('capability_contract_version', sa.String(length=64), nullable=False, server_default=''))
