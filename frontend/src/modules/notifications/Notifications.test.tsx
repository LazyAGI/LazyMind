...
const mocks = vi.hoisted(() => ({ prefs: vi.fn(), patch: vi.fn(), schedule: vi.fn(), put: vi.fn(), runs: vi.fn(), accounts: vi.fn(), targets: vi.fn(), execution: vi.fn(), attempts: vi.fn(), retry: vi.fn() }));
...
vi.mock('./api', async importOriginal => ({ ...await importOriginal<typeof import('./api')>(), getPreferences: mocks.prefs, patchPreferences: mocks.patch, getScheduleNotifications: mocks.schedule, putScheduleNotifications: mocks.put, getTargets: mocks.targets, getExecutionNotifications: mocks.execution, getAttempts: mocks.attempts, retryNotice: mocks.retry }));
