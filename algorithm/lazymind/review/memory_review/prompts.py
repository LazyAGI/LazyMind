...
MEMORY_REVIEW_PROMPT = (
    ...
    "- Update only existing leaf fields shown in current_profile. Put all Profile field changes in one "
    "MemoryTools_profile_editor call. Never infer Profile facts, and do not store transient task "
    "context as Profile.\n\n"
    "## Preference\n"
    ...
    "- Objective user facts such as name, aliases, pronouns, locale, languages, timezone, role, "
    "organization, industry, expertise, or accessibility needs belong in Profile when a matching "
