...
MEMORY_REVIEW_PROMPT = (
    ...
    "- The YAML frontmatter must contain at least these fields: 智能体角色, 用户称谓, 回复风格.\n"
    "- Required opening shape:\n"
    "  ---\n"
    "  智能体角色: \"<role/persona>\"\n"
    "  用户称谓: \"<user preferred name>\"\n"
    "  回复风格: \"<简洁|详细|幽默|正式|concise|detailed|humorous|formal|empty string>\"\n"
    "  ---\n"
    ...
    "- Modify 智能体角色, 用户称谓, or 回复风格 only when the user explicitly asks to change that specific field or clearly states the corresponding stable preference.\n"
    "- If the durable update is an ordinary user profile/preference, keep existing frontmatter values unchanged, including an existing valid 回复风格 in either language, and write the new information in the Markdown body.\n"
