...
RESPONSE_LANGUAGE_GUIDANCE = (
    ...
    "2. The user's saved language preference.\n"
    "3. The dominant natural language of the current user request.\n"
    "4. The dominant language of the user's recent conversation messages.\n"
    "5. The session default language from the UI locale supplied below.\n"
