...
from .window import RESULT_BYTE_BUDGET, grep_lines, read_lines_window, split_logical_lines, utf8_size
...
def grep_remote(uri, pattern, max_results):
    ...
    return {'target': uri, 'kind': 'skill_reference', 'pattern': pattern, 'matches': matches,
            ...
            'hint': 'Use read_file(target, offset=hit line) to read the matching reference.'}
