...
class MemoryTools:
    ...
    @fc_register(host_file_access='NONE', read_keys=_read_memory_keys)
    def read_memory(
        self,
    ...
    @fc_register(host_file_access='NONE', read_keys=_read_memory_reference_keys)
    ...
    @fc_register(host_file_access='NONE', write_keys=('memory', SOUL_PATH))
    ...
    @fc_register(host_file_access='NONE', write_keys=('memory', PROFILE_PATH))
    ...
    @fc_register(host_file_access='NONE', write_keys=[
