...
{'kb_search': {'argument': 'query',  # noqa: E122
 ...
 'grep': {'argument': 'target',
          'call': {'en': 'Searching file {value} for matching lines.',
                   'zh': '正在文件 {value} 中检索匹配行。'},
          'success': {'en': 'Matching lines from file {value} are ready.',
                      'zh': '已找到文件 {value} 的匹配行。'},
          'failure': {'en': 'File grep for {value} could not be completed.',
                      'zh': '未能检索文件 {value}。'}},
