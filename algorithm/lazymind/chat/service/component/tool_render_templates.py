...
{'kb_search': {'argument': 'query',  # noqa: E122
 ...
 'run_skill_script': {'argument': 'rel_path',
                      ...
                      'failure': {'en': 'Skill helper script at {value} did not finish.',
                                  'zh': '技能 {value} 的预定义脚本未能运行完成。'}},
 'delete_session_env': {'argument': 'name',
                        'call': {'en': 'Removing session override {value}.',
                                 'zh': '正在移除会话环境变量 {value}。'},
                        'success': {'en': 'Session override removal processed for {value}.',
                                    'zh': '已处理会话环境变量 {value} 的移除请求。'},
                        'failure': {'en': 'Could not remove session override {value}.',
                                    'zh': '未能移除会话环境变量 {value}。'}},
 'delete_user_env': {'argument': 'name',
                     'call': {'en': 'Requesting confirmation to delete user variable {value}.',
                              'zh': '正在请求确认删除用户级环境变量 {value}。'},
                     'success': {'en': 'User variable deletion request processed for {value}.',
                                 'zh': '已处理用户级环境变量 {value} 的删除申请。'},
                     'failure': {'en': 'Could not request deletion of user variable {value}.',
                                 'zh': '未能申请删除用户级环境变量 {value}。'}},
 'set_user_env': {'argument': 'name',
                  'call': {'en': 'Requesting secure input for user variable {value}.',
                           'zh': '正在请求安全输入用户级环境变量 {value}。'},
                  'success': {'en': 'Secure input requested for user variable {value}.',
                              'zh': '已请求安全输入用户级环境变量 {value}。'},
                  'failure': {'en': 'Could not request input for user variable {value}.',
                              'zh': '未能请求输入用户级环境变量 {value}。'}},
 'set_session_env': {'argument': 'name',
                     'call': {'en': 'Setting session environment variable {value}.',
                              'zh': '正在配置会话环境变量 {value}。'},
                     'success': {'en': 'Secure input requested for session variable {result.name}.',
                                 'zh': '已请求安全输入会话环境变量 {result.name}。'},
