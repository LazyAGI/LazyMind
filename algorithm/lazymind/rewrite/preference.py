...
def _build_user_preference_prompt(
    ...
    return (
        ...
        '\n'
        '[Format requirements]\n'
        '- Must start with YAML frontmatter delimited by `---`, containing at least 智能体角色, 用户称谓, and 回复风格 fields, followed by a blank line and Markdown body content.\n'  # noqa: E501
        '- 智能体角色 means the role the user wants the agent to play, such as secretary, engineer, reviewer, or research assistant.\n'  # noqa: E501
        '- 用户称谓 means the user preferred name or how the user wants the agent to address them, such as a preferred name, title, or pronoun.\n'  # noqa: E501
        '- When creating 回复风格 or explicitly changing it, display/use exactly one of 简洁, 详细, 幽默, 正式 when the user language is Chinese; otherwise display/use exactly one of concise, detailed, humorous, formal.\n'  # noqa: E501
        '- Do not put language preferences, formatting rules, citation rules, workflow constraints, task procedures, verbs, or full instructions in 回复风格; write those details in the Markdown body.\n'  # noqa: E501
        ...
        '- Use "" when 智能体角色, 用户称谓, or 回复风格 is unknown. If 回复风格 is missing or invalid during format repair and the user did not specify one, use "".\n'  # noqa: E501
        '- Modify 智能体角色, 用户称谓, or 回复风格 only when user_instruct explicitly asks to change that specific field or clearly states the corresponding stable preference.\n'  # noqa: E501
        '- If user_instruct only adds ordinary profile/preferences, keep existing frontmatter values unchanged, including an existing valid 回复风格 in either language, and write the new information in the Markdown body.\n'  # noqa: E501
        '- Write concrete user profile/preference entries in the Markdown body after the closing `---`.\n'
        '- The Markdown body must NOT repeat information already captured in the frontmatter fields (智能体角色, 用户称谓, 回复风格). For example, do not write "角色：技术助理", "用户希望被称呼为老师", or "回复风格：简洁" in the body when those values are already in the frontmatter.\n'  # noqa: E501
        '\n'
