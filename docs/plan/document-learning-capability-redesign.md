...
1. **能力类别（Capability Type）**：解释、翻译、拼音、赏析等由代码注册。新增类别需要研发改代码、补充 Schema、执行逻辑、权限、i18n 和测试。
...
| `pinyin` | 拼音 | 汉字、词、句 | 拼音、声调、多音字说明 | 汉语/文言词典 + 规则 |
| `literary_appreciation` | 赏析 | 句、段、文章 | 手法、证据、效果、主旨关系 | 预存内容 + LLM |

其中“解释”在产品界面可以是一级分组，但工程上应拆成 `english_definition`、`chinese_definition`、`classical_definition`。三者使用不同 Schema、Provider 和适用范围，不能仅依靠一个 `language` 参数分支。
...
| 场景组合 | 默认能力 | 典型用途 |
|---|---|---|
| 通用知识库 | 解释、翻译 | 产品资料、内部文档和混合材料 |
| 论文集 | 术语解释、翻译、段落解析、方法解读 | 中英文论文阅读、专业术语学习 |
| 语文学习·现代文 | 汉语解释、拼音、赏析、段落解析 | 现代文阅读、修辞和主旨学习 |
| 语文学习·文言文 | 文言文解释、拼音、文言文翻译、赏析 | 古文实词、句式、翻译和鉴赏 |
| 英语学习 | 英语释义、翻译、发音/音标 | 英文阅读、词汇积累和复习 |
| 法律文献 | 法律术语解释、条款释义、翻译、要件分析 | 法条、合同、判例和涉外法律材料 |
| 技术文档 | 技术术语解释、翻译、代码/公式说明 | API 文档、架构文档和工程资料 |
| 历史资料 | 人物/事件解释、时间线、古文翻译 | 史料阅读和知识点整理 |
