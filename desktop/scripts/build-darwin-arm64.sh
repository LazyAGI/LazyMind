...
LAZYLLM_RELEASE_URL="${LAZYMIND_LAZYLLM_RELEASE_URL:-https://github.com/LazyAGI/LazyLLM/releases/download/v1.2.0a2/lazyllm-1.2.0a2.tar.gz}"
...
"${UV_BIN}" pip install --python "${RUNTIME_ROOT}/deps/python/algorithm/bin/python" --link-mode copy --strict 'setuptools<81' "lazyllm@${LAZYLLM_RELEASE_URL}"
